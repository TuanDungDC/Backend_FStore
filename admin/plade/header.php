...
<head>
  ...
  <title>FSTORE | BẢNG ĐIỀU KHIỂN</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="home.php?flag=1" class="brand-link">
      <img src="dist/img/FStore.png" alt="FSTORE LOGO" class="brand-image img-circle elevation-3"
           style="opacity: 1">
      <span class="brand-text font-weight-light">FSTORE</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">NGUYỄN TUẤN DŨNG</a>
        </div>
      </div>
